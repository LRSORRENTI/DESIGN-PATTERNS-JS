...
// in the constructor
var FancyLogger = /** @class */ (function () {
    ...
    FancyLogger.prototype.log = function (message) {
        this.logs.push(message);
        console.log("Fancy: ".concat(message));
    };
    FancyLogger.prototype.printLogCount = function () {
